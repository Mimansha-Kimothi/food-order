    ...
    <div class="wrapper">
        ...
        <form action="" method="POST">
            ...
            <table class="tbl-full">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="customer_contact" value="<?php echo $customer_contact; ?>" pattern="\d{10}" title="Please enter a valid 10-digit phone number" required>
                    </td>
                </tr>
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                $_SESSION['update'] = "<div class='error'>" . implode("<br>", $errors) . "</div>";
                header('location:' . SITEURL . 'admin/manage-order.php');
            }
        }
        ?>
